...
function Definitions()
	...
	TaskForce = {
	{
		...
		,"Boba_Fett_Team_Land_MP | Darth_Team_Land_MP | General_Veers_Team | X1_Empire_Team | Emperor_Palpatine_Team | Mara_Jade_Team | The_Inquisitor_Team | = 0,1"
		,"Han_Solo_Team_Land_MP | X2_Rebel_Team | Obi_Wan_Team | Droids_Team | Katarn_Team | Yoda_Team | Luke_Skywalker_Jedi_Team | Garm_Bel_Iblis_Team | General_Kota_Jedi_Team = 0,1"
		...
		,"EN_Imperial_Pod_Walker_Company | Empire_Pirate_Skiff_Team | Empire_Pirate_Swamp_Speeder_Team | Imperial_Stormtrooper_Squad | Imperial_Artillery_Corp | Imperial_Anti_Infantry_Brigade | Ferroda_Team | Imperial_Heavy_Scout_Squad | Imperial_Heavy_Assault_Company | Imperial_Light_Scout_Squad | Dark_Trooper_Team | DarkTrooper_P2_Company | DarkTrooper_P3_Company | Noghri_Assassin_Squad | Imperial_Shock_Trooper_Heavy_Squad | Imperial_Purgetrooper_Company | Hailfire_Tank_Company | | | |= 0,3"
